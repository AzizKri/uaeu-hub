        ...
        <div className={styles.container}>
            ...
            <ul className={styles.links}>
                <li className={`${styles.link} ${styles.facebook}`}>
                    <a
                        href={`https://www.facebook.com/sharer.php?u=https%3A%2F%2Fuaeu.chat%2Fpost%2F${id}`}
                        target="_blank"
                    >
                ...
                <li className={`${styles.link} ${styles.x}`}>
                    <a
                        href={`https://x.com/intent/tweet?url=https%3A%2F%2Fuaeu.chat%2Fpost%2F${id}`}
                        target="_blank"
                    >
                ...
                <li className={`${styles.link} ${styles.whatsapp}`}>
                    <a
                        href={`https://api.whatsapp.com/send?text=https%3A%2F%2Fuaeu.chat%2Fpost%2F${id}`}
                ...
                <li className={`${styles.link} ${styles.telegram}`}>
                    <a href={`https://t.me/share/url?url=https%3A%2F%2Fuaeu.chat%2Fpost%2F${id}`} target="_blank">
